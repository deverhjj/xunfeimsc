package com.envision.flutter.plugins.xunfeimsc;
...
import com.huajianjiang.flutter.plugins.xunfeimsc.PermissionUtil;
...
public class SpeechRecognitionController implements PluginRegistry.RequestPermissionsResultListener {
    ...
    private boolean requestPermissions() {
        ...
        boolean permissionsDenied = !PermissionUtil.verifyAllPermissions(activity, PERMISSIONS);
    ...
    private RecognizerListener recognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult recognizerResult, boolean islast) {
            ...
            if (recognizerResult == null || TextUtils.isEmpty(jsonResult)) {
                return;
            }
            Log.d(TAG, "onResult: " + parseRecognitionResult(jsonResult));
            Map<Object, Object> result = new HashMap<>();
            result.put("result", parseRecognitionResult(jsonResult));
